 ...
 *   <li>未映射路径（{@link NoResourceFoundException}）→ 404（同时设 HTTP 404）；</li>
...
public class GlobalExceptionHandler {
     ...
     *
     * <p>与其余处理器（HTTP 200 + 响应体 code）不同，这里同时设真实 HTTP 404：「路径不存在」
     * 属路由层面的 HTTP 语义，网关、探活方与监控都按状态码判断；响应体仍保留 {@link Result} 结构。
     */
